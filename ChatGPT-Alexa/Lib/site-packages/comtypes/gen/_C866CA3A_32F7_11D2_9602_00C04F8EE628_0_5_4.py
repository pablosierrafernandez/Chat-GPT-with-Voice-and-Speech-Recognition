...
__all__ = [
    'eLEXTYPE_PRIVATE7', 'ISpeechXMLRecoResult', 'SpeechMicTraining',
    'SVP_12', 'SVSFParseMask', 'DISPID_SDKEnumValues',
    'ISpStreamFormatConverter', 'DISPID_SPEsItem',
    'SAFT44kHz8BitStereo', 'eWORDTYPE_ADDED',
    'ISpObjectTokenCategory', 'SPEI_PHRASE_START',
    'SPEI_PROPERTY_STRING_CHANGE', 'SAFTCCITT_uLaw_44kHzMono',
    'SDKLDefaultLocation', 'SPRST_INACTIVE', 'SREBookmark',
    'ISpeechMMSysAudio', 'SAFT16kHz8BitMono',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVGetProfiles',
    'DISPID_SVSPhonemeId', 'SPRECOGNIZERSTATUS',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SVEBookmark', 'SVSFVoiceMask',
    'SPCS_ENABLED', 'SDKLLocalMachine', 'DISPID_SPCLangId',
    'DISPID_SpeechPhraseReplacements', 'SpStream', 'SPEVENT',
    'eLEXTYPE_PRIVATE15', 'SAFT12kHz8BitMono', 'SPPS_Function',
    'DISPID_SMSSetData', 'DISPID_SVSLastResult',
    'DISPID_SLGetPronunciations', 'SVP_15',
    'DISPID_SABufferNotifySize', 'DISPID_SRAudioInput',
    'SPXMLRESULTOPTIONS', '_RemotableHandle', 'SpeechTokenValueCLSID',
    'SVESentenceBoundary', 'SPBO_AHEAD', 'SPEI_SR_PRIVATE',
    'SPCONTEXTSTATE', 'STSF_CommonAppData', 'SAFT24kHz8BitStereo',
    'DISPID_SPANumberOfElementsInResult', 'SVPOver',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRRSaveToMemory',
    'DISPID_SpeechPhraseReplacement', 'SpMemoryStream',
    'ISpeechVoiceStatus', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRGDictationLoad', 'SPLO_DYNAMIC', 'SP_VISEME_20',
    'SPGS_ENABLED', 'SSFMOpenReadWrite',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SPRuleId',
    'eLEXTYPE_PRIVATE2', 'DISPID_SPPBRestorePhraseFromMemory',
    'SAFTNonStandardFormat', 'DISPID_SRSetPropertyNumber',
    'SpeechSpecialTransitionType', 'SpResourceManager', 'SPCT_SLEEP',
    'SVP_14', 'SVSFIsXML', 'SRSInactive', 'DISPID_SRRSetTextFeedback',
    'DISPID_SRCERecognition', 'DISPID_SPRuleParent',
    'DISPID_SPRuleName', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SpeechPhraseAlternates', 'SSTTWildcard', 'DISPID_SVVoice',
    'SPWORDPRONOUNCEABLE', 'DISPID_SGRsItem', 'SPSModifier',
    'SPVOICESTATUS', 'DISPID_SWFEFormatTag', 'DISPID_SOTCategory',
    'DISPID_SpeechPhraseAlternate', 'SVP_19',
    'DISPID_SRGCmdLoadFromResource', 'SP_VISEME_0',
    'DISPID_SRCEPhraseStart', 'DISPID_SPRuleChildren',
    'SAFT24kHz16BitStereo', 'SPWAVEFORMATTYPE',
    'DISPID_SRRRecoContext', 'SDKLCurrentUser', 'DISPID_SRGetFormat',
    'DISPID_SGRSTsItem', 'SpMMAudioIn', 'STCAll',
    'eLEXTYPE_PRIVATE16', 'SPEI_HYPOTHESIS', 'SGRSTTWildcard',
    'SGRSTTTextBuffer', 'DISPID_SGRSTType',
    'DISPID_SpeechRecoResultTimes', 'SpeechRuleAttributes',
    'DISPID_SRSSupportedLanguages', 'SPEI_PHONEME', 'DISPID_SRCState',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SOTGetDescription', 'SPPS_Unknown', 'DISPID_SVEStreamEnd',
    'DISPID_SOTId', 'eLEXTYPE_PRIVATE5', 'ISpPhraseAlt',
    'DISPID_SpeechVoiceEvent', 'DISPID_SAFSetWaveFormatEx',
    'SpSharedRecoContext', 'DISPID_SLAddPronunciationByPhoneIds',
    'SAFT11kHz16BitMono', 'DISPID_SRGCommit', 'SpObjectTokenCategory',
    'SpLexicon', 'SP_VISEME_15', 'SPPS_Interjection',
    'DISPIDSPTSI_ActiveLength', 'SPINTERFERENCE_NOSIGNAL',
    'ISpXMLRecoResult', 'SECFDefault', 'SINoise',
    'SpeechEngineProperties', 'SAFT16kHz8BitStereo',
    'SpCompressedLexicon', 'SP_VISEME_7', 'SpeechEngineConfidence',
    'IInternetSecurityManager', 'DISPID_SPILanguageId',
    'DISPID_SGRSTsCount', 'SVSFNLPMask', 'SpeechCategoryRecognizers',
    'SP_VISEME_10', 'SAFT16kHz16BitStereo', 'SVEStartInputStream',
    'SBONone', 'SVSFParseAutodetect', 'DISPID_SRCreateRecoContext',
    'SpeechPropertyResourceUsage', 'Speech_Default_Weight',
    'SpTextSelectionInformation', 'SAFT24kHz8BitMono',
    'SpeechVisemeFeature', 'DISPID_SABIEventBias',
    'DISPID_SPRuleEngineConfidence',
    'DISPID_SOTRemoveStorageFileName',
    'DISPID_SVSInputSentencePosition', 'DISPID_SVEAudioLevel',
    'DISPID_SRSClsidEngine', 'SPSLMA', 'SDTLexicalForm',
    'DISPID_SPARecoResult', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SVSVisemeId', 'SPSSuppressWord', 'SFTInput',
    'DISPID_SLWsCount', 'SpeechAudioFormatType', 'eLEXTYPE_PRIVATE11',
    'SPEVENTENUM', 'DISPID_SPPParent', 'DISPID_SLGenerationId',
    'WAVEFORMATEX', 'ISpeechRecoResultDispatch',
    'DISPID_SRCEBookmark', 'eLEXTYPE_PRIVATE9', 'SECFNoSpecialChars',
    'SpeechRecognitionType', 'DISPID_SAFGuid',
    'ISpeechPhraseProperties', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SGRsFindRule', 'SPEI_TTS_PRIVATE',
    'DISPID_SDKDeleteValue', 'Speech_StreamPos_Asap',
    'SPEI_INTERFERENCE', 'STCInprocServer', 'STSF_FlagCreate',
    'SpeechGrammarRuleStateTransitionType', 'SPPHRASEREPLACEMENT',
    'DISPID_SGRSRule', 'SPWT_DISPLAY', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpeechRecoProfileProperties', 'SP_VISEME_21', 'DISPID_SRStatus',
    'STCLocalServer', 'SPGRAMMARSTATE', 'DISPID_SGRSTNextState',
    'DISPID_SpeechObjectToken', 'DISPID_SVSpeakStream',
    'DISPID_SLWsItem', 'SSSPTRelativeToCurrentPosition', 'SVPNormal',
    'ISpRecognizer', 'SAFTADPCM_11kHzMono', 'SGRSTTRule',
    'DISPID_SDKEnumKeys', 'SpeechRecoEvents', 'ISpRecoCategory',
    'SPBO_TIME_UNITS', 'SSFMCreate', 'SAFT12kHz16BitStereo',
    '_SPAUDIOSTATE', 'SPBINARYGRAMMAR', 'eLEXTYPE_PRIVATE18',
    'DISPID_SPAs_NewEnum', 'ISpeechObjectToken',
    'ISpeechRecoResultTimes', 'SpPhoneticAlphabetConverter', 'SVP_17',
    'SECFIgnoreWidth', 'SpeechCategoryAudioOut', 'SREAdaptation',
    'DISPID_SPRulesItem', 'SPCS_DISABLED', 'SAFTCCITT_ALaw_44kHzMono',
    'SREInterference', 'SREHypothesis', 'eLEXTYPE_RESERVED6',
    'DISPID_SPEDisplayText', 'SVP_1', 'DISPID_SpeechPhraseBuilder',
    'SPWORD', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPDATAKEYLOCATION', 'SAFT44kHz8BitMono',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpRecoResult',
    'ISpeechBaseStream', 'DISPID_SDKGetBinaryValue', 'SPINTERFERENCE',
    'SPEI_TTS_AUDIO_LEVEL', 'SPAS_RUN', 'DISPID_SVAudioOutput',
    'SVEAllEvents', 'SPVPRI_ALERT', 'SpeechVoiceSkipTypeSentence',
    'SAFT11kHz8BitMono', 'SpeechVoiceEvents', 'SPPS_SuppressWord',
    'ISpeechPhraseElement', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SLGetWords',
    'DISPID_SRCESoundEnd', 'SPPHRASEPROPERTY', 'DISPID_SPCIdToPhone',
    'SBOPause', 'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRCEHypothesis',
    'SRATopLevel', 'SPEI_SOUND_END', 'SP_VISEME_14',
    'ISpeechTextSelectionInformation', 'eLEXTYPE_PRIVATE14',
    'DISPID_SVEStreamStart', 'ISpeechObjectTokenCategory',
    'SRERecognition', 'SPEI_FALSE_RECOGNITION',
    'ISpeechPhoneConverter', 'DISPID_SVGetVoices',
    'DISPID_SRSetPropertyString', 'SPRS_ACTIVE',
    'SREPropertyStringChange',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SP_VISEME_8',
    'DISPID_SOTIsUISupported', 'SAFTCCITT_ALaw_22kHzMono',
    'SVSFPersistXML', 'ISpMMSysAudio', 'DISPID_SOTs_NewEnum',
    'SASClosed', 'SPCT_SUB_COMMAND', 'eLEXTYPE_PRIVATE13',
    'ISpeechRecognizer', 'SITooSlow', 'SPEI_SOUND_START',
    'ISpObjectToken', 'DISPID_SVSkip', 'ISpeechLexicon',
    'DISPID_SABufferInfo', 'SPDKL_LocalMachine', 'eWORDTYPE_DELETED',
    'ISpeechRecoResult', 'SpeechCategoryAudioIn',
    'DISPID_SCSBaseStream', 'SPEI_SR_BOOKMARK',
    'DISPID_SpeechRecoResult', 'SpeechRegistryUserRoot', 'SLTApp',
    'DISPID_SPAsItem', 'SPSUnknown', 'DISPID_SPPNumberOfElements',
    'DISPID_SVSpeakCompleteEvent', 'SVP_8',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRRPhraseInfo', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SLWPronunciations', 'SPEI_START_INPUT_STREAM',
    'SRAInterpreter', 'ISpRecognizer3', 'DISPID_SGRsCount', 'SINone',
    'SRADefaultToActive', 'eLEXTYPE_PRIVATE1',
    'SDA_One_Trailing_Space', 'SPWORDLIST',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SPIEnginePrivateData',
    'DISPID_SpeechGrammarRule', 'SP_VISEME_3',
    'DISPID_SpeechPhraseInfo', 'SPINTERFERENCE_TOOFAST',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SVSRunningState',
    'DISPID_SRCEInterference', 'SpeechStreamFileMode', 'SVP_21',
    'DISPID_SGRAttributes', 'DISPID_SpeechLexicon',
    'DISPID_SPCPhoneToId', 'SPCT_COMMAND', 'DISPID_SMSADeviceId',
    'SVP_5', 'DISPID_SGRId', 'SRAORetainAudio',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SREPrivate', 'ISpeechRecoContext',
    'SpeechCategoryPhoneConverters', 'eLEXTYPE_PRIVATE20',
    'ISpeechPhraseRule', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SGRClear', 'ISpeechPhraseProperty', 'SPGRAMMARWORDTYPE',
    'ISpeechObjectTokens', 'DISPID_SRCEAdaptation',
    'DISPID_SDKSetStringValue', 'DISPID_SMSALineId',
    'SpNotifyTranslator', 'SVEAudioLevel',
    'SDA_Consume_Leading_Spaces', 'SDTReplacement',
    'SpeechBookmarkOptions', 'IEnumString', 'DISPID_SVEViseme',
    'DISPID_SRRTOffsetFromStart', 'SVSFIsNotXML',
    'SpeechAudioFormatGUIDWave', 'eLEXTYPE_PRIVATE4',
    'DISPID_SGRAddResource', 'SP_VISEME_18', 'DISPID_SRCEAudioLevel',
    'SAFTADPCM_44kHzMono', 'DISPID_SpeechLexiconPronunciation',
    'SPEI_WORD_BOUNDARY', 'DISPID_SpeechObjectTokenCategory',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPAO_NONE', 'SpCustomStream',
    'IEnumSpObjectTokens', 'SPRECOCONTEXTSTATUS', 'DISPID_SPRsItem',
    'DISPID_SRGDictationSetState', 'DISPID_SASCurrentDevicePosition',
    'SVSFlagsAsync', 'ISpPhrase', 'SAFT8kHz8BitMono',
    'SpeechAudioVolume', 'DISPID_SOTGetAttribute',
    'ISpeechPhraseReplacements', 'SGDSActive', 'SPAR_Low', 'SLTUser',
    'SSTTTextBuffer', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SABIMinNotification',
    'DISPID_SVPause', 'DISPID_SVResume', 'eLEXTYPE_PRIVATE6',
    'SDTPronunciation', 'SPAR_High', 'ISpShortcut', 'SPPHRASEELEMENT',
    'SVPAlert', 'SAFTCCITT_uLaw_22kHzStereo', 'SPADAPTATIONRELEVANCE',
    'SpeechGrammarTagDictation', 'SPPHRASERULE', 'SpAudioFormat',
    'DISPID_SVSyncronousSpeakTimeout', 'tagSPPROPERTYINFO',
    'DISPID_SOTCSetId', 'ISpPhoneticAlphabetConverter',
    'DISPID_SGRSTs_NewEnum', 'SPRS_INACTIVE', 'SRARoot',
    'SPLO_STATIC', 'ISpeechGrammarRules', 'SPSEMANTICFORMAT',
    'SDA_Two_Trailing_Spaces', 'SP_VISEME_11', 'DISPID_SVRate',
    'SVP_13', 'DISPID_SPEAudioSizeBytes', 'DISPID_SPPFirstElement',
    'SpeechRetainedAudioOptions', 'SAFT12kHz8BitStereo',
    'SpInprocRecognizer', 'SpeechTokenIdUserLexicon',
    'DISPID_SpeechObjectTokens', 'DISPID_SVAudioOutputStream',
    'DISPID_SVEEnginePrivate',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SWFESamplesPerSec',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SGRSTText',
    'DISPID_SPRuleNumberOfElements', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SRCERequestUI', 'SPWORDPRONUNCIATION', 'DISPID_SLPLangId',
    'SPEI_MIN_SR', 'SpPhoneConverter', 'Speech_StreamPos_RealTime',
    'DISPID_SVWaitUntilDone', 'DISPID_SRRTTickCount',
    'ISpeechLexiconWord', 'SPPROPERTYINFO', 'SVSFParseSapi',
    'SGSDisabled', 'SECHighConfidence', 'DISPID_SPRsCount',
    'SGSEnabled', 'SPEI_RESERVED6', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SBSWrite', 'SPSHORTCUTPAIRLIST', 'SAFT12kHz16BitMono',
    'ISpNotifySource', 'SAFT44kHz16BitStereo',
    'SpeechPropertyNormalConfidenceThreshold', 'SpPhraseInfoBuilder',
    'SECFEmulateResult', 'SPPARTOFSPEECH', 'SpeechLoadOption',
    'SGRSTTDictation', 'SPGS_EXCLUSIVE', 'DISPID_SRGIsPronounceable',
    'DISPID_SRCERecognitionForOtherContext', 'SAFT48kHz8BitStereo',
    'SpeechLexiconType', 'eLEXTYPE_RESERVED9', 'SPSNoun', 'SVP_7',
    'SpeechWordPronounceable', 'DISPID_SpeechFileStream',
    'DISPID_SGRName', 'DISPID_SGRSTPropertyId', 'SAFTText',
    'DISPID_SRCESoundStart', 'ISpAudio', 'eLEXTYPE_PRIVATE8',
    'SAFT16kHz16BitMono', 'SVEPrivate', 'DISPID_SPACommit',
    'DISPID_SpeechRecoResult2', 'DISPID_SRGDictationUnload',
    'SPPS_RESERVED2', 'SREPropertyNumChange', 'SPEI_REQUEST_UI',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SGRsCommit',
    'DISPID_SRState', 'SPPS_Verb', 'SAFT24kHz16BitMono',
    'DISPID_SPEActualConfidence', 'DISPID_SGRSTransitions',
    'SVEPhoneme', 'SRCS_Enabled', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SAVolume', 'SPRECORESULTTIMES', 'SpeechVoicePriority',
    'DISPID_SLPType', 'ISpeechRecognizerStatus',
    'ISpeechPhraseAlternate', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SOTDisplayUI', 'SASRun', 'ISpeechVoice', 'SREAllEvents',
    'DISPID_SpeechWaveFormatEx', 'SITooQuiet',
    'DISPID_SDKSetBinaryValue', 'SRTStandard', 'SPAUDIOSTATUS',
    ...
    'SVSFDefault', 'ISpeechGrammarRule',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpRecoContext2', 'SVP_9',
    'SPCATEGORYTYPE', 'SAFT48kHz16BitStereo', 'SECNormalConfidence',
    'SPLEXICONTYPE', 'DISPID_SVEventInterests', 'SpeechAddRemoveWord',
    'ISpDataKey', 'SAFT22kHz16BitMono',
    'DISPID_SRSCurrentStreamNumber',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SWFEBlockAlign',
    'DISPID_SAEventHandle', 'DISPID_SRRTLength', 'SGRSTTEpsilon',
    'SpMMAudioOut', 'DISPID_SRGRules', 'SAFT8kHz16BitStereo',
    'DISPID_SRCPause', 'SPSFunction', 'SAFTGSM610_22kHzMono',
    ...
    'DISPID_SVEPhoneme', 'SpeechRegistryLocalMachineRoot', 'SASStop',
    ...
    'SPLOADOPTIONS', 'DISPID_SMSGetData', 'DISPID_SPEsCount',
    'SPINTERFERENCE_LATENCY_WARNING', 'SVEViseme', 'SP_VISEME_5',
    'ISpLexicon', 'SPSHT_NotOverriden',
    'ISpPhoneticAlphabetSelection', 'ISpRecognizer2', 'SGSExclusive',
    'DISPID_SMSAMMHandle', 'DISPID_SVSInputWordPosition',
    'SP_VISEME_4', 'DISPID_SPRuleConfidence', 'ISpeechMemoryStream',
    'DISPID_SRGId', 'SPFM_NUM_MODES', 'SpeechRecoContextState',
    'SPAR_Medium', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPIRule', 'SFTSREngine', 'DISPID_SpeechBaseStream',
    'DISPID_SOTsItem', 'SAFTCCITT_uLaw_11kHzStereo',
    ...
    'SREAudioLevel', 'SSTTDictation', 'SPEI_RESERVED3',
    'SpeechEmulationCompareFlags', 'SPWT_LEXICAL',
    'eLEXTYPE_RESERVED10', 'SAFT22kHz8BitMono',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SVSLastBookmarkId',
    'SPRULE', 'SP_VISEME_19', 'SLODynamic', 'SpInProcRecoContext',
    'SPSHT_Unknown', 'SPEI_MAX_TTS', 'SPEI_SR_RETAINEDAUDIO',
    'SpeechTokenContext', 'DISPID_SLAddPronunciation',
    'SPINTERFERENCE_NONE', 'SAFT32kHz8BitStereo', 'SGPronounciation',
    'SRTSMLTimeout', 'DISPID_SPPChildren', 'DISPID_SFSClose',
    'DISPID_SLWType', 'SPBOOKMARKOPTIONS', 'SAFT48kHz16BitMono',
    'SpeechTokenKeyUI', 'SpeechVoiceCategoryTTSRate',
    'SREStateChange', 'DISPID_SRCRetainedAudio', 'SPSHORTCUTPAIR',
    'SPTEXTSELECTIONINFO', 'SWTDeleted', 'SGDisplay',
    '_ISpeechVoiceEvents', 'SGLexical', 'DISPID_SRRAudioFormat',
    'ISpObjectWithToken', 'SpeechDisplayAttributes',
    'DISPID_SRRAlternates', 'DISPID_SRRecognizer',
    'SECFIgnoreKanaType', 'DISPID_SRRAudio',
    'SpeechGrammarTagWildcard', 'DISPID_SpeechPhoneConverter',
    'SSFMOpenForRead', 'SpeechTokenKeyAttributes', 'DISPID_SRRTimes',
    'DISPID_SPAPhraseInfo', 'eLEXTYPE_PRIVATE3', 'SPEI_RESERVED1',
    'SPFM_CREATE_ALWAYS', 'DISPID_SVSLastBookmark', 'SpeechRunState',
    'DISPID_SPRuleFirstElement', 'SVSFUnusedFlags', 'SP_VISEME_13',
    'SPAUDIOBUFFERINFO', 'DISPID_SpeechAudioStatus', 'SECFIgnoreCase',
    'DISPID_SpeechVoice', 'SPXRO_Alternates_SML',
    'Speech_Max_Pron_Length', 'DISPID_SPIEngineId',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpeechAudioStatus', 'SPPHRASE',
    'SPSEMANTICERRORINFO', 'SPAUDIOSTATE', 'SpWaveFormatEx',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SVGetAudioInputs',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPPId',
    'DISPID_SWFEChannels', 'DISPID_SVPriority', 'SRSEIsSpeaking',
    'SRSActive', 'SPBO_PAUSE', 'DISPID_SpeechDataKey',
    'DISPID_SPIAudioSizeBytes', 'SPVPRI_NORMAL', 'SPCT_SUB_DICTATION',
    'DISPID_SpeechCustomStream', 'DISPID_SRGCmdSetRuleIdState',
    'SPEI_RESERVED5', 'DISPID_SRSCurrentStreamPosition',
    'STCRemoteServer', 'DISPID_SPRText', 'ISequentialStream',
    'SDTProperty', 'DISPID_SGRsAdd', 'SpStreamFormatConverter',
    'SVF_None', '_ISpeechRecoContextEvents',
    'DISPID_SASNonBlockingIO', 'DISPID_SpeechLexiconWords',
    'SPINTERFERENCE_NOISE', 'SGDSActiveWithAutoPause',
    'ISpProperties', 'DISPID_SRGState', 'DISPID_SRCEStartStream',
    'SREStreamEnd', 'SAFTCCITT_ALaw_11kHzMono', 'SDTAudio',
    'DISPID_SVESentenceBoundary', 'SPEI_RESERVED2', 'DISPID_SAStatus',
    'DISPID_SPPsItem', 'SAFT22kHz16BitStereo', 'SAFTADPCM_8kHzStereo',
    'SWPUnknownWordUnpronounceable',
    'DISPID_SRCAudioInInterferenceStatus', 'SpUnCompressedLexicon',
    'SVP_20', 'DISPID_SRGetPropertyNumber',
    'DISPID_SpeechPhraseProperties',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SRTExtendableParse',
    'DISPID_SRRTStreamTime', 'SpeechDictationTopicSpelling',
    'DISPID_SGRSTWeight', 'SDTRule', 'SPPS_RESERVED1',
    'SpeechTokenShellFolder', 'SRAONone', 'DISPID_SRCEEndStream',
    'SVP_10', 'SPBO_NONE', 'SAFT8kHz16BitMono', 'eLEXTYPE_PRIVATE17',
    'SRSActiveAlways', 'SpeechRecognizerState',
    'SpeechCategoryRecoProfiles', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SGRAddState', 'SAFT11kHz8BitStereo', 'IStream',
    'DISPID_SRCBookmark', 'SPWORDTYPE', 'SPGS_DISABLED', 'SVP_16',
    'SPXRO_SML', 'SPWT_PRONUNCIATION', 'SAFTDefault', 'SPAS_CLOSED',
    'SRESoundEnd', 'SVP_18', 'SAFTADPCM_8kHzMono',
    'DISPID_SpeechXMLRecoResult', 'ISpStream', 'SP_VISEME_6',
    'DISPID_SPRs_NewEnum', 'ISpeechLexiconPronunciation',
    'eLEXTYPE_USER', 'ISpPhoneConverter',
    'DISPID_SpeechPhraseElement', 'SPWF_SRENGINE',
    'SWPKnownWordPronounceable', 'SpeechPropertyResponseSpeed',
    'DISPID_SPPs_NewEnum', 'ISpVoice', 'DISPID_SDKSetLongValue',
    'DISPID_SBSSeek', 'SAFTADPCM_22kHzStereo',
    'DISPID_SPELexicalForm', 'DISPIDSPTSI', 'SPVPRI_OVER',
    'DISPID_SVStatus', 'SPSVerb', 'DISPID_SPIStartTime',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SDKDeleteKey',
    'ISpeechAudio', 'DISPID_SLPPartOfSpeech', 'SP_VISEME_1',
    'eLEXTYPE_APP', 'DISPID_SpeechRecognizer',
    'DISPID_SPERequiredConfidence', 'SPRST_ACTIVE',
    'DISPID_SRCRequestedUIType', 'DISPID_SBSRead',
    'SVEEndInputStream', 'SDKLCurrentConfig', 'SpeechUserTraining',
    'SPAO_RETAIN_AUDIO', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPEI_END_SR_STREAM', 'ISpeechWaveFormatEx', 'ISpeechPhraseRules',
    'ISpeechAudioFormat', 'DISPID_SOTCEnumerateTokens',
    'SRCS_Disabled', 'STSF_AppData', 'SPEI_MAX_SR',
    'SpeechVoiceSpeakFlags', 'ISpeechPhraseAlternates',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SRCVoice', 'DISPID_SpeechRecognizerStatus',
    'SpeechAudioState', 'DISPID_SpeechRecoContext',
    'DISPID_SpeechGrammarRuleState', 'SGDSActiveUserDelimited',
    'DISPID_SPAsCount', 'DISPID_SRCEPropertyNumberChange',
    'ISpeechPhraseInfo', 'DISPID_SGRSTRule', 'SP_VISEME_12',
    'SPAS_PAUSE', 'ISpeechResourceLoader',
    'DISPID_SASFreeBufferSpace', 'SDTDisplayText',
    'SAFT48kHz8BitMono', 'DISPID_SPRulesCount',
    'DISPID_SPERetainedSizeBytes', 'SREFalseRecognition',
    'DISPID_SGRSTPropertyName', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SRIsUISupported', 'SPFM_CREATE', 'DISPID_SABIBufferSize',
    'DISPID_SRGReset', 'DISPID_SPIElements',
    'DISPID_SpeechAudioFormat', 'DISPID_SWFEExtraData',
    'SPSTREAMFORMATTYPE', 'SAFT8kHz8BitStereo',
    'DISPID_SPRules_NewEnum', 'DISPID_SRCResume', 'SP_VISEME_16',
    'ISpRecoGrammar', 'SPINTERFERENCE_TOOQUIET', 'SpeechPartOfSpeech',
    'SDTAlternates', 'DISPID_SpeechMemoryStream',
    'SGLexicalNoSpecialChars', 'ISpRecoContext', 'SpeechWordType',
    'SPSHORTCUTTYPE', 'DISPID_SASetState',
    ...
    'SPDKL_CurrentConfig', 'DISPID_SRCRecognizer', 'ISpNotifySink',
    'DISPID_SPIGetText', 'SPDKL_DefaultLocation',
    'ISpeechLexiconWords', 'eLEXTYPE_LETTERTOSOUND',
    'ISpNotifyTranslator', 'SPSInterjection',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SVVolume', 'DISPID_SVSpeak',
    'SpeechGrammarTagUnlimitedDictation', 'SLOStatic',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SBSFormat',
    'DISPID_SRProfile', 'SPSHT_EMAIL', 'SPSNotOverriden',
    'ISpeechPhraseElements', 'DISPID_SPRFirstElement', 'SRAExport',
    'DISPID_SPPEngineConfidence', 'SPRST_NUM_STATES',
    'DISPID_SLWs_NewEnum', 'SVP_0', 'SVP_2', 'SpeechAudioProperties',
    'DISPID_SRGSetTextSelection', 'SVP_4', 'ISpEventSource',
    'STSF_LocalAppData', 'DISPID_SPAStartElementInResult',
    'SPDKL_CurrentUser', 'SRAImport', 'SpeechAudioFormatGUIDText',
    'SAFT44kHz16BitMono', 'SPFILEMODE', 'SRSEDone',
    'SpeechVisemeType', 'SAFT22kHz8BitStereo', 'SVSFNLPSpeakPunc',
    'ISpeechRecoGrammar', 'SPPS_Noun', 'DISPID_SVEVoiceChange',
    'DISPID_SRDisplayUI', 'SPRS_ACTIVE_USER_DELIMITED', 'SpVoice',
    'DISPID_SASState', 'DISPID_SDKOpenKey', 'DISPID_SOTCGetDataKey',
    'SSFMCreateForWrite', 'SpeechRuleState', 'Speech_Max_Word_Length',
    'SAFTADPCM_44kHzStereo', 'DISPID_SPPConfidence', 'SPVPRIORITY',
    'SRERequestUI', 'SpFileStream', 'DISPID_SVDisplayUI',
    ...
    'SpeechInterference', 'DISPID_SGRInitialState',
    'SPEI_VOICE_CHANGE', 'SpShortcut', 'IInternetSecurityMgrSite',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SLPs_NewEnum',
    'SVF_Stressed', 'DISPID_SpeechVoiceStatus', 'eLEXTYPE_RESERVED8',
    'LONG_PTR', 'SRSInactiveWithPurge', 'STCInprocHandler',
    'SVEWordBoundary', 'DISPID_SPIGrammarId', 'SPEI_START_SR_STREAM',
    'DISPID_SVEWord', 'SAFT32kHz16BitMono', 'SVP_6',
    'DISPID_SPIRetainedSizeBytes', 'SAFTADPCM_11kHzStereo',
    'SREStreamStart', 'SP_VISEME_2', 'DISPID_SRCEFalseRecognition',
    'SRADynamic', 'SGDSInactive', 'DISPID_SDKGetStringValue',
    'DISPID_SpeechPhraseRule', 'SSSPTRelativeToStart', 'SITooLoud',
    'SGRSTTWord', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SOTDataKey',
    'SSSPTRelativeToEnd', 'SPRECOSTATE', 'SPEI_VISEME',
    'DISPID_SOTsCount', 'SPEI_END_INPUT_STREAM', 'ISpeechFileStream',
    'DISPID_SRSAudioStatus', 'DISPID_SREmulateRecognition',
    'ISpeechLexiconPronunciations', 'DISPID_SRAudioInputStream',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRGRecoContext', 'SPSMF_UPS',
    'SVSFIsFilename', 'DISPID_SFSOpen', '__MIDL_IWinTypes_0009',
    'ISpeechPhraseInfoBuilder', 'DISPID_SRCEEnginePrivate',
    'SpeechTokenKeyFiles', 'DISPIDSPTSI_ActiveOffset',
    'ISpeechDataKey', 'SPCT_DICTATION', 'SAFTNoAssignedFormat',
    'DISPID_SLWLangId', 'DISPID_SOTCDefault', 'SPPS_Modifier',
    'SP_VISEME_9', 'SDTAll', 'SPPS_LMA', 'SRERecoOtherContext',
    'SpObjectToken', 'DISPID_SpeechGrammarRules',
    'DISPID_SPRNumberOfElements', 'DISPID_SPEPronunciation',
    'SPEI_MIN_TTS', 'SpeechCategoryAppLexicons', 'ISpStreamFormat',
    'DISPID_SPEDisplayAttributes', 'DISPID_SPEEngineConfidence',
    'SPFM_OPEN_READWRITE', 'SRTEmulated', 'SPEI_TTS_BOOKMARK',
    'SAFTADPCM_22kHzMono', 'DISPID_SpeechPhraseProperty',
    'eLEXTYPE_RESERVED7', 'SPEI_UNDEFINED', 'SAFTGSM610_44kHzMono',
    'DISPID_SpeechLexiconWord', 'SPRULESTATE',
    'DISPID_SGRsCommitAndSave', 'SWTAdded', 'SpeechAllElements',
    'SITooFast', 'SAFT32kHz16BitStereo', 'SECLowConfidence',
    'SPPS_Noncontent', 'SpeechGrammarWordType', 'SVEVoiceChange',
    'DISPID_SOTCId', 'SVP_11', 'SWPUnknownWordPronounceable',
    'DISPID_SPIProperties', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SDKCreateKey', 'SAFT11kHz16BitStereo',
    'DISPID_SPIAudioStreamPosition', 'SPWF_INPUT', 'UINT_PTR',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPEs_NewEnum',
    'ISpRecoGrammar2', 'SAFTGSM610_11kHzMono',
    'DISPID_SVGetAudioOutputs', 'SPFM_OPEN_READONLY', 'SASPause',
    'ISpSerializeState', 'DISPID_SRRSpeakAudio', 'SAFT32kHz8BitMono',
    'SRTReSent', 'DISPID_SRGetRecognizers', 'ISpeechAudioBufferInfo',
    'SAFTExtendedAudioFormat', 'DISPID_SADefaultFormat',
    'ISpeechCustomStream', 'DISPID_SRCEventInterests',
    'SPEI_RECOGNITION', 'DISPID_SPIReplacements',
    'DISPID_SGRs_NewEnum', 'SDA_No_Trailing_Space', 'DISPIDSPRG',
    'ISpGrammarBuilder', 'DISPID_SLPPhoneIds', 'SpeechCategoryVoices',
    'DISPID_SVAlertBoundary', 'DISPID_SVSInputSentenceLength',
    'DISPID_SLGetGenerationChange', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'tagSTATSTG', 'SPSERIALIZEDPHRASE', 'ISpEventSink',
    'DISPID_SRIsShared', 'eLEXTYPE_PRIVATE12', 'SpeechFormatType',
    'SPSERIALIZEDRESULT', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SLPsItem',
    'eLEXTYPE_RESERVED4', 'SVF_Emphasis', 'SPEI_ADAPTATION',
    'DISPID_SpeechLexiconProns', 'DISPID_SpeechPhraseRules',
    'SPAS_STOP', 'SPVISEMES', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SLPsCount', 'SPPS_RESERVED4', 'SPEVENTSOURCEINFO',
    'SP_VISEME_17', 'SPPS_NotOverriden', 'tagSPTEXTSELECTIONINFO',
    'eLEXTYPE_PRIVATE19', 'DISPID_SPPName', 'SpMMAudioEnum', 'SVP_3',
    'DISPID_SPPsCount', 'SpeechDiscardType', 'ISpResourceManager',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SOTCreateInstance',
    'SINoSignal', 'ISpeechGrammarRuleState',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRCCreateGrammar',
    'SPAR_Unknown', 'SpeechPropertyAdaptationOn',
    'SpNullPhoneConverter', 'DISPID_SGRSAddSpecialTransition',
    'SpeechDataKeyLocation', 'DISPID_SPEAudioSizeTime',
    'ISpeechRecoResult2', 'SPAUDIOOPTIONS',
    'DISPID_SOTMatchesAttributes', 'SRTAutopause', 'SPPS_RESERVED3',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPPValue', 'SVSFParseSsml',
    'SVEBookmark', 'DISPID_SGRsDynamic', 'DISPID_SAFType',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpeechGrammarState', 'SRESoundStart',
    'DISPID_SOTRemove', 'SPEI_SENTENCE_BOUNDARY',
...
_check_version('1.1.14', 1624046036.221324)
